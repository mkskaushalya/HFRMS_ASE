    ...
    <section id="hall-facilities">
        <div class="cont">
            ...
            <div class="facilities">
                <div class="facility">
                    <img src="{{ url('img/check.png') }}" alt="Facility Image">
                    <p>Facility 1</p>
                </div>
                <div class="facility">
                    <img src="{{ url('img/check.png') }}" alt="Facility Image">
            ...
            <div class="availability">
                <div class="search-form">
                    ...
                    <form
                        ...
                        <div class="input-box">
                            <button type="submit" id="checkAvailabilitySubmitBtn">
                                @if (Auth::check())
                                    {{ $values['form_type'] && $hallAvailability ? 'Book' : 'Check' }}
                                @else
                                    Login to Book
                                @endif
                            </button>
                ...
                <div class="left">
                    ...
                    <div class="rating-bars">
                        <div class="rating-bar">
                            ...
                            <div class="bar">
                                <div class="fill"
                                    @if ($rating_count[5] == 0) style="width: 0%"
                                    @else
                                        style="width: {{ ($rating_count[5] / $hall->reviews->count()) * 100 }}%" @endif>
                                </div>
                            </div>
                        ...
                        <div class="rating-bar">
                            ...
                            <div class="bar">
                                <div class="fill"
                                    @if ($rating_count[4] == 0) style="width: 0%"
                                @else
                                    style="width: {{ ($rating_count[4] / $hall->reviews->count()) * 100 }}%" @endif>
                                </div>
                            </div>
                        ...
                        <div class="rating-bar">
                            ...
                            <div class="bar">
                                <div class="fill"
                                    @if ($rating_count[3] == 0) style="width: 0%"
                            @else
                                style="width: {{ ($rating_count[3] / $hall->reviews->count()) * 100 }}%" @endif>
                                </div>
                            </div>
                        ...
                        <div class="rating-bar">
                            ...
                            <div class="bar">
                                <div class="fill"
                                    @if ($rating_count[2] == 0) style="width: 0%"
                                @else
                                    style="width: {{ ($rating_count[2] / $hall->reviews->count()) * 100 }}%" @endif>
                                </div>
                            </div>
                        ...
                        <div class="rating-bar">
                            ...
                            <div class="bar">
                                <div class="fill"
                                    @if ($rating_count[1] == 0) style="width: 0%"
                                @else
                                    style="width: {{ ($rating_count[1] / $hall->reviews->count()) * 100 }}%" @endif>
                                </div>
                            </div>
                        </div>
                ...
                <div class="right">
                    ...
                    <div id="review-edit-form" class="review-form hidden">
                        @if (Auth::check())
                            ...
                            <form name="reviewEditForm" action="" method="POST" class="myform">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="input-box submit-btns">
                                    <button type="button" class="button delete"
                                        id="review-edit-form-close-btn">Cancel
                                    </button>
                                            ...
                                            <ul class="action-dropdown">
                                                <li>
                                                    <a href="{{ route('halls.reviews', [$hall, $review]) }}"
                                                        ...
                                                        data_review_rating="{{ $review->rating }}">Edit</a>
                                                </li>
                                                <li>
                                                    <button type="submit"
                                                    ...
                                                    <form id="reviewDeleteForm-{{ $review->id }}"
