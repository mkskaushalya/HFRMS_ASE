                    ...
                    <form action="" method="POST" class="myform">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" min="{{ today()->format("Y-m-d") }}"
                                   value="{{ $tempBooking->booking_date }}" readonly
                        ...
                        <div class="input-box">
                            ...
                            <input type="text"
                                   value="{{ $tempBooking->start_time }}"
                                   name="start_time" id="start_time" readonly required>
                            @error('start_time')
                            <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="input-box">
                            ...
                            <div class="ratio-items">
                                <input type="checkbox" name="offlinepayment" id="offlinepayment" required>
